...
suite('Util Test Suite', () => {
    ...
    test('traverseUntilUnmatchedParen.stringEmpty', () => {
        assert.strictEqual(undefined, util.traverseUntilUnmatchedParen(String.raw`(1""4)`, 0, -1));
        assert.strictEqual(0, util.traverseUntilUnmatchedParen(String.raw`(1""4)`, 1, -1));
        assert.strictEqual(0, util.traverseUntilUnmatchedParen(String.raw`(1""4)`, 2, -1));
        assert.strictEqual(0, util.traverseUntilUnmatchedParen(String.raw`(1""4)`, 3, -1, { currentStringType: '"' }));
        assert.strictEqual(0, util.traverseUntilUnmatchedParen(String.raw`(1""4)`, 4, -1));
        assert.strictEqual(0, util.traverseUntilUnmatchedParen(String.raw`(1""4)`, 5, -1));
        assert.strictEqual(undefined, util.traverseUntilUnmatchedParen(String.raw`(1""4)`, 6, -1));

        assert.strictEqual(undefined, util.traverseUntilUnmatchedParen(String.raw`(1""4)`, 0, 1));
        assert.strictEqual(5, util.traverseUntilUnmatchedParen(String.raw`(1""4)`, 1, 1));
        assert.strictEqual(5, util.traverseUntilUnmatchedParen(String.raw`(1""4)`, 2, 1));
        assert.strictEqual(5, util.traverseUntilUnmatchedParen(String.raw`(1""4)`, 3, 1, { currentStringType: '"' }));
        assert.strictEqual(5, util.traverseUntilUnmatchedParen(String.raw`(1""4)`, 4, 1));
        assert.strictEqual(5, util.traverseUntilUnmatchedParen(String.raw`(1""4)`, 5, 1));
        assert.strictEqual(undefined, util.traverseUntilUnmatchedParen(String.raw`(1""4)`, 6, 1));
    });
    ...
    test('moveCursor.nested', () => {
        assert.strictEqual(undefined, util.getCursorOffsetAfterJump(String.raw`(1, (5, 8))`, 0, -1));
        assert.strictEqual(1, util.getCursorOffsetAfterJump(String.raw`(1, (5, 8))`, 1, -1));
        assert.strictEqual(1, util.getCursorOffsetAfterJump(String.raw`(1, (5, 8))`, 2, -1));
        assert.strictEqual(1, util.getCursorOffsetAfterJump(String.raw`(1, (5, 8))`, 3, -1));
        assert.strictEqual(1, util.getCursorOffsetAfterJump(String.raw`(1, (5, 8))`, 4, -1));
        assert.strictEqual(5, util.getCursorOffsetAfterJump(String.raw`(1, (5, 8))`, 5, -1));
        assert.strictEqual(5, util.getCursorOffsetAfterJump(String.raw`(1, (5, 8))`, 6, -1));
        assert.strictEqual(5, util.getCursorOffsetAfterJump(String.raw`(1, (5, 8))`, 7, -1));
        assert.strictEqual(5, util.getCursorOffsetAfterJump(String.raw`(1, (5, 8))`, 8, -1));
        assert.strictEqual(8, util.getCursorOffsetAfterJump(String.raw`(1, (5, 8))`, 9, -1));
        assert.strictEqual(4, util.getCursorOffsetAfterJump(String.raw`(1, (5, 8))`, 10, -1));
        assert.strictEqual(undefined, util.getCursorOffsetAfterJump(String.raw`(1, (5, 8))`, 11, -1));

        assert.strictEqual(undefined, util.getCursorOffsetAfterJump(String.raw`(1, (5, 8))`, 0, 1));
        assert.strictEqual(2, util.getCursorOffsetAfterJump(String.raw`(1, (5, 8))`, 1, 1));
        assert.strictEqual(10, util.getCursorOffsetAfterJump(String.raw`(1, (5, 8))`, 2, 1));
        assert.strictEqual(10, util.getCursorOffsetAfterJump(String.raw`(1, (5, 8))`, 3, 1));
        assert.strictEqual(10, util.getCursorOffsetAfterJump(String.raw`(1, (5, 8))`, 4, 1));
        assert.strictEqual(6, util.getCursorOffsetAfterJump(String.raw`(1, (5, 8))`, 5, 1));
        assert.strictEqual(9, util.getCursorOffsetAfterJump(String.raw`(1, (5, 8))`, 6, 1));
        assert.strictEqual(9, util.getCursorOffsetAfterJump(String.raw`(1, (5, 8))`, 7, 1));
        assert.strictEqual(9, util.getCursorOffsetAfterJump(String.raw`(1, (5, 8))`, 8, 1));
        assert.strictEqual(9, util.getCursorOffsetAfterJump(String.raw`(1, (5, 8))`, 9, 1));
        assert.strictEqual(10, util.getCursorOffsetAfterJump(String.raw`(1, (5, 8))`, 10, 1));
        assert.strictEqual(undefined, util.getCursorOffsetAfterJump(String.raw`(1, (5, 8))`, 11, 1));
    });
    test('moveCursor.string', () => {
        assert.strictEqual(undefined, util.getCursorOffsetAfterJump(String.raw`("23", 78)`, 0, -1));
        assert.strictEqual(1, util.getCursorOffsetAfterJump(String.raw`("23", 78)`, 1, -1));
        assert.strictEqual(1, util.getCursorOffsetAfterJump(String.raw`("23", 78)`, 2, -1));
        assert.strictEqual(1, util.getCursorOffsetAfterJump(String.raw`("23", 78)`, 3, -1));
        assert.strictEqual(1, util.getCursorOffsetAfterJump(String.raw`("23", 78)`, 4, -1));
        assert.strictEqual(1, util.getCursorOffsetAfterJump(String.raw`("23", 78)`, 5, -1));
        assert.strictEqual(1, util.getCursorOffsetAfterJump(String.raw`("23", 78)`, 6, -1));
        assert.strictEqual(1, util.getCursorOffsetAfterJump(String.raw`("23", 78)`, 7, -1));
        assert.strictEqual(7, util.getCursorOffsetAfterJump(String.raw`("23", 78)`, 8, -1));
        assert.strictEqual(7, util.getCursorOffsetAfterJump(String.raw`("23", 78)`, 9, -1));
        assert.strictEqual(undefined, util.getCursorOffsetAfterJump(String.raw`("23", 78)`, 10, -1));

        assert.strictEqual(undefined, util.getCursorOffsetAfterJump(String.raw`("23", 78)`, 0, 1));
        assert.strictEqual(5, util.getCursorOffsetAfterJump(String.raw`("23", 78)`, 1, 1));
        assert.strictEqual(5, util.getCursorOffsetAfterJump(String.raw`("23", 78)`, 2, 1));
        assert.strictEqual(5, util.getCursorOffsetAfterJump(String.raw`("23", 78)`, 3, 1));
        assert.strictEqual(5, util.getCursorOffsetAfterJump(String.raw`("23", 78)`, 4, 1));
        assert.strictEqual(9, util.getCursorOffsetAfterJump(String.raw`("23", 78)`, 5, 1));
        assert.strictEqual(9, util.getCursorOffsetAfterJump(String.raw`("23", 78)`, 6, 1));
        assert.strictEqual(9, util.getCursorOffsetAfterJump(String.raw`("23", 78)`, 7, 1));
        assert.strictEqual(9, util.getCursorOffsetAfterJump(String.raw`("23", 78)`, 8, 1));
        assert.strictEqual(9, util.getCursorOffsetAfterJump(String.raw`("23", 78)`, 9, 1));
        assert.strictEqual(undefined, util.getCursorOffsetAfterJump(String.raw`("23", 78)`, 10, 1));
    });
